...
from pyformationlib.gcp.network import GCPNetwork
...
from pyformationlib.gcp.config.node import (GCPInstance, AttachedDisk, NodeConfiguration, TerraformElement, RequiredProvider, GCPTerraformProvider,
...
class GCPDeployment(object):
    ...
    def node_config(self, group: int, ssh_key: str, config: NodeConfig):
        ...
        for n in range(int(quantity)):
            ...
            node_swap_disk = f"node_{n + 1}_swap_disk"
            node_data_disk = f"node_{n + 1}_data_disk"
