...
from pyformationlib.gcp.driver.constants import get_auth_directory, get_default_credentials

logger = logging.getLogger('pyformationlib.gcp.driver.base')
...
class CloudBase(object):
    ...
    def __init__(self, config: BaseConfig):
        ...
        if config.auth == AuthMode.default:
            ...
            raise GCPDriverError(f"Unsupported auth mode {config.auth.name}")
