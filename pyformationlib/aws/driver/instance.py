...
import logging
from pyformationlib.aws.driver.base import CloudBase, AWSDriverError
from pyformationlib.aws.driver.constants import AWSEbsDisk, AWSTagStruct, EbsVolume, AWSTag

logger = logging.getLogger('pyformationlib.aws.driver.instance')
