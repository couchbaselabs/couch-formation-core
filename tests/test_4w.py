...
class TestMainAWS(unittest.TestCase):
    ...
    def test_1(self):
        args = ["create", "--build", "cbs", "--cloud", "aws", "--project", "pytest-aws", "--name", "test-cluster", "--auth_mode", "sso",
                ...
                "--ssh_key", r"C:\Users\adminuser\.ssh\mminichino-default-key-pair.pem", "--machine_type", "4x16"]
        cm = CloudMgrCLI(args)
    ...
    def test_2(self):
        args = ["add", "--build", "cbs", "--cloud", "aws", "--project", "pytest-aws", "--name", "test-cluster", "--auth_mode", "sso",
                ...
                "--ssh_key", r"C:\Users\adminuser\.ssh\mminichino-default-key-pair.pem", "--machine_type", "4x16", "--services", "analytics"]
        cm = CloudMgrCLI(args)
        project = Project(cm.options, cm.remainder)
        project.add()
